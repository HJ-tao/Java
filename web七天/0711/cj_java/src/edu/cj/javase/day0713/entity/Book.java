...
public class Book {
	...
	public String toString() {
		return "Book [buyId=" + buyId + ", taxNo=" + taxNo + ", bookId="
				+ bookId + ", bookPrice=" + bookPrice + ", bookDiscount="
				+ bookDiscount + ", truePrice=" + truePrice + ", bookMount="
				+ bookMount + ", bookMoney=" + bookMoney + "]";
	}
